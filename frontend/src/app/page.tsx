        ...
        <div className="bg-gray-950 border-2 border-orange-900 rounded-lg shadow-2xl p-8 w-full max-w-md">
          ...
          <div className="w-full space-y-3">
            ...
            <button
              ...
              className="w-full bg-white hover:bg-gray-100 text-gray-900 font-semibold py-3 px-4 rounded-lg transition-colors border border-gray-300 flex items-center justify-center gap-2"
            >
